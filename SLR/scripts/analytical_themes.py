...
lines = [
    ...
    "",
    "> **Cluster measurement note**: The AT1 cluster sizes above (ML={n_ml_cluster}, Gov={n_gov_cluster},",
    f"> Bridge={n_bridging}) are the **canonical** thematic counts, based on DT-constitutive-code",
    "> membership (DT2+DT9 = ML cluster; DT5 = Gov cluster). The Phase F4 bibliometric analysis",
    "> uses a different operationalization (keyword-fraction >0.6), which yields ML=21, Gov=20,",
    "> Bridge=3 — a complementary but distinct measure. Readers comparing the two should note",
