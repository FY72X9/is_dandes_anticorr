...
framing (\texttt{IST-NONE}). IS theory appears exclusively in the governance cluster,
...
confirms that governance scholars have fully established the problem domain; RIGOR$\times$village\,=\,11
confirms that methodological frameworks exist. What the research community has not produced
is the Design-cycle artefact that connects them, and this absence is invariant across all
three sensitivity thresholds.
...
feature categories: single-bidder ratios, amendment frequencies, price escalation,
timing concentration, and vendor diversity \cite{p008,p043}. Two village-specific additions
...
\textbf{Research implications}: Future work must develop boundary-spanning frameworks
that translate corruption mechanisms into computational features while preserving
theoretical fidelity to institutional dynamics. The prevalence of synthetic-data validation
(AT4) and label-scarce conditions (G2) necessitates new evaluation paradigms.
