...
The pipeline operationalises the DeLone and McLean information-quality-to-organisational-impact pathway by producing ranked inspection outputs at two analytical levels: at the **activity level**, 99,692 records are filtered to 3,107 consensus anomalies (96.9% search space reduction); at the **entity level**, 1,364 villages are prioritised to 642 Tier-1 villages (47.1%) — without any pre-existing labels or supervised training. These outputs serve complementary inspection functions: activity-level records for document examination and entity-level villages for field audit scheduling.
