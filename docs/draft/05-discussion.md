...
- **Organisational Impact**: APIP operational coverage gap closure depends on whether inspectorates adopt ranked pipeline outputs as inspection inputs. This study does not measure adoption rates (an inherent limitation of technical research without implementation evaluation), but the inspection search space reduction directly addresses the staffing constraint Srirejeki and Faturokhman [28] document.
